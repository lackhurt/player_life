                ...
                <table class="table table-hover">
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td>
                                <button type="button" class="btn btn-default sub-resume">
                                    投递简历
                                </button>
                            </td>
                        </tr>
            ...
            <div class="row">
                <form class="form-horizontal" method="POST" action="<% url('/user/resume/create') %>">
                    ...
                    <div class="row">
                        ...
                        <div class="col-xs-6">
                            <textarea class="form-control" name="apply_introduction" id="applyIntroduction"  rows="5">前职业选手，带你装逼带你飞，天梯一局100，普通一局60，支持小费，买5赠1待打天梯5000——5500 1500块。。。。。</textarea>
                        </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-xs-6">
                            <textarea class="form-control" name="game_experience" id="gameExperience"  rows="5">TI1亚军TI2冠军各种吹牛逼</textarea>
                        </div>
